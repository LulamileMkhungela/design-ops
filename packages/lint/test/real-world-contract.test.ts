...
// designops install, run against the fixture project. It exercises what a
...
describe("a complete policy for a designops install", () => {
      ...
      [
        {
          ...
          rules: { "designops/no-restyle": ["error", policy] },
        },
      ] as any,
      { filename: PAGE }
    )
