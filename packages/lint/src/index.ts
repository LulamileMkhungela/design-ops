// @designops/lint: the plugin, and a small window onto the project model.
...
declare module "@eslint/core" {
  interface RulesConfig {
    "designops/no-restyle"?: import("@eslint/core").RuleConfig<
      [
        {
          allow?: string[]
          deny?: string[]
    ...
    >
    "designops/no-raw-colors"?: import("@eslint/core").RuleConfig<
      [
        {
          allow?: string[]
          deny?: string[]
    ...
    >
    "designops/no-arbitrary-values"?: import("@eslint/core").RuleConfig<
      [
        {
          allow?: string[]
          deny?: string[]
    ...
    >
    "designops/no-inline-styles"?: import("@eslint/core").RuleConfig<
      [
        {
          allow?: string[]
          deny?: string[]
    ...
    >
    "designops/require-static-classes"?: import("@eslint/core").RuleConfig<
      [
        {
          message?: string
          componentImports?: string[]
    ...
    >
    "designops/no-unknown-classes"?: import("@eslint/core").RuleConfig<
      [
        {
          allow?: string[]
          deny?: string[]
