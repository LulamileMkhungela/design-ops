...
export const RULES = {
  "designops/no-restyle": ["error", NO_RESTYLE_OPTIONS],
  "designops/no-raw-colors": "error",
  "designops/no-arbitrary-values": ["error", NO_ARBITRARY_VALUES_OPTIONS],
...
// non-designops setup passes them to both rules that need them.
export function rulesFor(manifest) {
  ...
  return {
    ...RULES,
    "designops/no-restyle": ["error", { ...NO_RESTYLE_OPTIONS, ...options }],
    "designops/require-static-classes": ["error", options],
  }
}
