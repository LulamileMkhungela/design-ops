# Set up @designops/lint

Install and register `@designops/lint` in the user's project. Do not enable
new rules or change existing rule policies. Once setup is complete, help
the user find where to configure their rules.

Read the [setup and configuration documentation](https://github.com/LulamileMkhungela/design-ops/blob/main/README.md#get-started)
...
- Find the component directories, import aliases, and Tailwind v4 themes.
  ...
  [discovery documentation](https://github.com/LulamileMkhungela/design-ops/blob/main/docs/how-it-works.md)
...
[Vue](https://github.com/LulamileMkhungela/design-ops/blob/main/docs/vue.md) and [Svelte](https://github.com/LulamileMkhungela/design-ops/blob/main/docs/svelte.md) documentation.
...
- That no new `@designops/lint` rules were enabled. If the project already
  had rules configured, explain that those were preserved.
- Where to add rules, and where to read the
  [available rules](https://github.com/LulamileMkhungela/design-ops/blob/main/README.md#rules)
  and [configuration examples](https://github.com/LulamileMkhungela/design-ops/blob/main/docs/design-systems.md).
